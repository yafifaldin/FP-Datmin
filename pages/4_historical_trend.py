...
# ── Line chart ─────────────────────────────────────────────────────────────────
st.html('<p class="section-label">Monthly average miss distance (AU)</p>')
...
fig_line.add_annotation(
    ...
    text=f"  closest avg &middot; {monthly_miss.loc[min_idx, 'miss_distance_au']:.4f} AU",
...
fig_line.update_layout(
    ...
    xaxis=dict(showgrid=False, tickfont=dict(color="#3d4460"), tickangle=-30),
...
# ── Histogram ──────────────────────────────────────────────────────────────────
st.html('<p class="section-label">Diameter distribution (log scale)</p>')
...
st.html('<p class="section-label">Monthly close approaches (&lt; 10 lunar distances)</p>')
...
# ── Summary table ──────────────────────────────────────────────────────────────
st.html('<p class="section-label">Monthly summary</p>')
